		...
		<div class="{register_window:spansize}">
			<div class="register-block">
				...
				<form component="register/local" class="form-horizontal" role="form" action="{config.relative_path}/register" method="post">
					...
					<div class="form-group">
						<label for="invite" class="col-lg-4 control-label">[[pr:invite-label]]</label>
						<div class="col-lg-8">
							<input class="form-control" type="text" name="invite" id="invite" value="{invite}"/>
							<span class="register-feedback" id="invite-notify"></span>
						</div>
					</div>
