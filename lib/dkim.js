...
const { string_remove_starts_with, pr_lock, pr_unlock, inspect, errorWithResponse } = require('./utility');
...
async function uploadPOST(req, res) {
	...
	const next = `${nconf.get('relative_path')}/pr_dkim_register?status=${status}&uuid=${uuid}`;
